<template>
  ...
  <div class="container">
    <div class="row justify-content-between mt-3">
      <div
        class="group m-2 d-flex align-items-center justify-content-center"
...
const grupos: Reactive<{ name: string; id: string; group_id: string }>[] =
  reactive([]);
onMounted(() => {
  axios.get(`${API_URL}/get-all-groups`).then((res) => {
